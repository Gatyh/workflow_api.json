# =============================================================================
# ComfyUI Docker - 3DTexel PBR & Decal Only
# =============================================================================
...
# -----------------------------------------------------------------------------
# PBR Workflows:
#   - Input: Albedo image (1K-4K)
#   - Output: Albedo (4K/8K), Normal, Height, Roughness, Metallic
#   - GPU requis: 8GB+ VRAM
#
# Decal Workflow:
#   - Input: Image avec alpha channel
#   - Output: Albedo, Opacity, Normal, Height, Roughness (4K/8K)
#   - GPU requis: 8GB+ VRAM
# =============================================================================
